...
<div class="row">
  <div class="col"  style="width:40%;text-align:left">    
   ...
   <a style="border:none; color:#4B0082; font-weight: bold; font-size:20px;" class="nav-link" href="cargopersonal.php"><img src=Draw/agregar.png style=" width:30px; height:30px;">
   ...
   <label style="font-size:40px; text-align: center;font-family: Century Gothic,CenturyGothic,AppleGothic,sans-serif;" class="control-label">Lista del Personal</label>
   </div>
